...
if ($transaction == 'settlement') {
   ...
   mysqli_query($con,"update peserta set transaction_status='3' , transaction_id='$transaction_id' where order_id='$order_id'");
       ...
       include "../../db/config.php";
   mysqli_query($con,"update user set transaction_status='2' where order_id='$order_id'");
 
} else if ($transaction == 'deny') {
      include "../../db/config.php";
   mysqli_query($con,"update user set transaction_status='1' where order_id='$order_id'");
