...
if (isset($_SESSION['username'])) {
    ...
    // Sekarang Anda dapat menggunakan $username di dalam halaman ini
} else {
    // Jika session tidak ada, mungkin pengguna belum login
    // Anda dapat menangani ini sesuai kebutuhan Anda, seperti mengarahkan mereka kembali ke halaman login
...
<body>
    ...
    <div id="map_unregistered"  style="width: 100%; height:100vh;"></div>
                    <!-- Tempatkan elemen dengan ID 'registered-cta-container' di mana Anda ingin menampilkan konten CTA -->
                    <div id="registered-cta-container"></div>
...
<script src="../../static/js/map/map_unregistered.js"></script>
